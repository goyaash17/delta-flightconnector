...
/**
 * A <code>DeltaFlightConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link DeltaFlightConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-09-20T06:18:05-07:00", comments = "Build UNNAMED.2793.f49b6c7")
public class DeltaFlightConnectorLifecycleInjectionAdapter
    extends DeltaFlightConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(DeltaFlightConnectorLifecycleInjectionAdapter.class);
