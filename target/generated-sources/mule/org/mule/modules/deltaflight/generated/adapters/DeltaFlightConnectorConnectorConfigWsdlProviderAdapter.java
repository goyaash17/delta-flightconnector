...
/**
 * A <code>DeltaFlightConnectorConnectorConfigWsdlProviderAdapter</code> is a wrapper around {@link DeltaFlightConnector } that represents the WSDL generic connector {@link ConnectorConfig }
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-09-20T06:18:05-07:00", comments = "Build UNNAMED.2793.f49b6c7")
public class DeltaFlightConnectorConnectorConfigWsdlProviderAdapter implements ProcessAdapter<WsdlAdapter> , Disposable, ConnectorMetaDataEnabled, WsdlAdapter
{

    private WSResolver wsResolver;
    private ConnectorConfig config;
    protected DeltaFlightConnectorProcessAdapter connector;
    ...
    {
        if (connector == null) {
            connector = new DeltaFlightConnectorProcessAdapter();
     ...
     * 
     */
    public DeltaFlightConnectorProcessAdapter getConnector() {
        if (connector == null) {
            try {
    ...
    public List<ServiceDefinition> serviceDefinitions()
        throws Exception
    {
        return new ArrayList<ServiceDefinition>(Arrays.asList(getConfig().getServiceDefinition()));
    }
    ...
    public Optional<String> singleServiceDefinitionId()
        throws Exception
    {
        return Optional.of(this.wsResolver().serviceDefinitions().values().asList().get(0).getId());
    }
